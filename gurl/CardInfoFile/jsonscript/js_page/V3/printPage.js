...
var MultipleImages_table_Question = item_Question.values[67].formattedValue;//صور متعددة
    ...
    var IdCardString = getIdCard.replace('ID1000000', '');
    var IdCards = parseInt(IdCardString);
    var IdCard = IdCards + 2;

if(IdCard <= 1){
  var errorset = {status:0}
recost_error(errorset);
  return false;
}
...
var recosts_each = recosts.sheets[0].data[0].rowData;
