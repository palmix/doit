...
var MultipleImages_table_Question = item_Question.values[67].formattedValue;//معرف المجلد
...
var ScientificName_Answer = item.values[6].formattedValue;//الإسم العلمي
...
var ImgMaps_Answer = item.values[64].formattedValue;//خريطة ألتواجد
...
var Img_JSON = item.values[68].formattedValue;//صورة الحيوان
var ImgSizeComparison_JSON = item.values[69].formattedValue;//صورة مقارنة الحجم
var ImgMaps_JSON = item.values[70].formattedValue;//خريطة ألتواجد
var ImgCover_JSON = item.values[71].formattedValue;//صورة الغلاف


  
var linkallimg = 'https://lh4.googleusercontent.com/u/0/d/';
var default_img = 'https://lh3.googleusercontent.com/-nngQTpjLnLk/WwI4sFyHQfI/AAAAAAAACdM/CFZJhtiKCMgR6syKazo7tsM4_xVtpML7gCEwYBhgL/s1600/GeoArabic.png';

  

  
var Img_JSON_url,Img_JSON_id,Img_JSON_width,Img_JSON_height,Img_Answer_favorite;
if(Img_JSON == "" || Img_JSON == "NoData" || Img_JSON == undefined){
Img_Answer = default_img;
Img_Answer_favorite = default_img;
Img_JSON_id = "NoData";
Img_JSON_width = 0;
Img_JSON_height = 0;
}else{
Img_JSON = JSON.parse(Img_JSON);
Img_Answer = linkallimg+Img_JSON.id;
Img_Answer_favorite = linkallimg+Img_JSON.id+'=s160';
Img_JSON_id = Img_JSON.id;
Img_JSON_width = Img_JSON.width;
Img_JSON_height = Img_JSON.height;
}
  
  

var ImgSizeComparison_JSON_url,ImgSizeComparison_JSON_id,ImgSizeComparison_JSON_width,ImgSizeComparison_JSON_height;
if(ImgSizeComparison_JSON == "" || ImgSizeComparison_JSON == "NoData" || ImgSizeComparison_JSON == undefined){
ImgSizeComparison_Answer = "NoData";
ImgSizeComparison_JSON_id = "NoData";
ImgSizeComparison_JSON_width = 0;
ImgSizeComparison_JSON_height = 0;
}else{
ImgSizeComparison_JSON = JSON.parse(ImgSizeComparison_JSON);
ImgSizeComparison_Answer = linkallimg+ImgSizeComparison_JSON.id;
ImgSizeComparison_JSON_id = ImgSizeComparison_JSON.id;
ImgSizeComparison_JSON_width = ImgSizeComparison_JSON.width;
ImgSizeComparison_JSON_height = ImgSizeComparison_JSON.height;
}
...
var ImgMaps_JSON_url,ImgMaps_JSON_id,ImgMaps_JSON_width,ImgMaps_JSON_height;
if(ImgMaps_JSON == "" || ImgMaps_JSON == "NoData" || ImgMaps_JSON == undefined){
ImgMaps_Answer = "NoData";
ImgMaps_JSON_id = "NoData";
ImgMaps_JSON_width = 0;
ImgMaps_JSON_height = 0;
}else{
ImgMaps_JSON = JSON.parse(ImgMaps_JSON);
ImgMaps_Answer = linkallimg+ImgMaps_JSON.id;
ImgMaps_JSON_id = ImgMaps_JSON.id;
ImgMaps_JSON_width = ImgMaps_JSON.width;
ImgMaps_JSON_height = ImgMaps_JSON.height;
}
...
var ImgCover_JSON_url,ImgCover_JSON_id,ImgCover_JSON_width,ImgCover_JSON_height;
if(ImgCover_JSON == "" || ImgCover_JSON == "NoData" || ImgCover_JSON == undefined){
ImgCover_Answer = "NoData";
ImgCover_JSON_id = "NoData";
ImgCover_JSON_width = 0;
ImgCover_JSON_height = 0;
}else{
ImgCover_JSON = JSON.parse(ImgCover_JSON);
ImgCover_Answer = linkallimg+ImgCover_JSON.id;
ImgCover_JSON_id = ImgCover_JSON.id;
ImgCover_JSON_width = ImgCover_JSON.width;
ImgCover_JSON_height = ImgCover_JSON.height;
}
...
Img_Answer = Img_Answer+'=w'+Img_W+'-h'+Img_H+'-p';
...
var ImgMaps_Answer = new_item.values[64].formattedValue;//خريطة ألتواجد
...
var Img_JSON = new_item.values[68].formattedValue;//صورة الحيوان
var ImgSizeComparison_JSON = new_item.values[69].formattedValue;//صورة مقارنة الحجم
var ImgMaps_JSON = new_item.values[70].formattedValue;//خريطة ألتواجد
var ImgCover_JSON = new_item.values[71].formattedValue;//صورة الغلاف
...
$("#linkcardb").val(setIDCard);
      ...
      Published = parseInt(Published); //حالة النشر
        ...
        PopulationTrend_Num = parseInt(PopulationTrend_Num); //رقم إتجاه السكان الحالي
        RedList_Num = parseInt(RedList_Num); //رقم حالة القائمة الحمراء (IUCN)
		Img_Answer = Img_Answer+"=w136-h136-p";
        ImgSizeComparison_Answer = ImgSizeComparison_Answer+"=s162";
		ImgMaps_Answer = ImgMaps_Answer+"=s162";
...
setAllMultipleImages(table,IncludeImg,ScientificName_Answer,CommonName_Answer,CommonName_Answer_En,MultipleImages_table,galleryId);
...
var ImgSizeComparison = ImgSizeComparison_Answer+"=s400";
...
var ImgMapsAnswer = ImgMaps_Answer+"=s400";
