...
var getIdCard = '';
try{
getIdCard = $.query.get("user");
}catch(e){
$("#MyProfile").html('<div class="alert alert-warning d-flex align-items-center my-4" role="alert"> <i class="fa fa-exclamation-triangle mx-2" aria-hidden="true"></i> <div> حدث خطأ في في جلب الملف الشخصي </div> </div>');
}
...
setUserPost(recosts,UserAccountId,UserName,UserGender);
              ...
              $("#MyProfile").removeClass('d-none');
              $("#MyProfile").html('<div class="alert alert-warning d-flex align-items-center my-4" role="alert"> <i class="fa fa-exclamation-triangle mx-2" aria-hidden="true"></i> <div> يبدو أنك إتبعت رابط خاطئ </div> </div>');
}
