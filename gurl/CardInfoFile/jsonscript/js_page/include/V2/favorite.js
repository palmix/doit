 ...
 function setFavorite_Error(error){
 ...
 function setUserFavoritePost(UserAccountIds,UserNames,UserGenders){
...
var getPostxs = Object.keys(data);
var n = 0;
...
for (var nom = 0, len = getPostxs.length; nom < len; nom++) {
    data[getPostxs[nom].value] = getPostxs[nom];
    if(postid == getPostxs[nom]){		  
cards1num += 1;
GetList(cards1);
...
if (cards1num <= 0){
  ...
  $("#FavoritePostUser").html(cards1num);
