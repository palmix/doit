...
$('#remove_columns').click(function() {
 ...
 $("#randomstyle").click(function(){
	...
	$("#randomstyle").html(setRandomStyle+' <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
...
makeTableCode();
			...
			$("#randomstyle").html(setRandomStyle);
...
if (coll2 === "TRUE"){
backgroundtr2 = backgroundtr2;
}else{
backgroundtr2 = backgroundtr;
}
...
listusercode +='<div class="input-group p-1 Searchcode">';
...
document.getElementById('listusercode').innerHTML = listusercode;
